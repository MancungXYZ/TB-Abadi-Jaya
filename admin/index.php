                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="index.php"><i class="fa fa-user"></i><span>Dashboard Pegawai</span></a></li>
        ...
        <div class="main-content">
				...
				if(mysqli_num_rows($sql) > 0) {
					...
					while($data = mysqli_fetch_assoc($sql)) {
						...
						<tr>
                            ...
                            <td>'.$data['alamat'].'</td>
                            <td>
                            <a href="karyawan-edit.php?id_karyawan='.$data['id_karyawan'].'" class="badge badge-warning">Edit</a>
                            <a href="karyawan-delete.php?id_karyawan='.$data['id_karyawan'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
                            </td>
						</tr>
						';
						$no++;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <p class="mb-3">Masukan Data Karyawan</p>
                    <form action="" method="post">
			        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">ID</label>
                        <div class="col-sm-10 mb-3">
                            <input type="number" name="id_karyawan" class="form-control" size="4" required>
                        </div>
			        </div>
			        <div class="form-group row">
            ...
            <?php
                ...
                // Bersihkan data
                    $ID = $koneksi->escape_string($_POST["id_karyawan"]);
                    ...
                    $hp = $koneksi->escape_string($_POST["no_hp"]);
                    $alamat = $koneksi->escape_string($_POST["alamat"]);
                    //Menyusun SQL
                    $sql = "INSERT INTO karyawan (id_karyawan, nama_karyawan, posisi, password, no_hp, alamat) VALUES ('$ID','$nama_karyawan','$posisi', '$password', '$hp', '$alamat')";
